...
<form action="perform_login" name="form-login" method="post">
<div class="container">
  <div class="row" style="padding-left:50px;">
    <div class="col-lg-6 col-md-6 col-sm-3 col-xs-12 accountborder" style="">
      ...
      <input type="email" class="form-control accountpad2 accounttextboxcolor bord" id="email" placeholder="" name="userName">
      <p class="accountgreycolor accounttext accountpad">PASSWORD*</p>
      <input type="password" class="form-control accountpad2 accounttextboxcolor bord" id="pwd" placeholder="" name="userPassword">
